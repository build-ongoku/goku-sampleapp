...
func (meta TypeJobApplicantMeta) SetMetaFieldValues(ctx context.Context, obj svccore_entjobapplicant_typ.JobApplicant, now time.Time) svccore_entjobapplicant_typ.JobApplicant {
...
func (meta TypeJobApplicantMeta) ConvertTimestampColumnsToUTC(obj svccore_entjobapplicant_typ.JobApplicant) svccore_entjobapplicant_typ.JobApplicant {
	return obj
}
...
func (meta TypeJobApplicantDALMeta) ScanDBNextRow(rows *sql.Rows) (svccore_entjobapplicant_typ.JobApplicant, error) {
...
func (meta *TypeJobApplicantDALMeta) UpdateSubTableFields(ctx context.Context, conn db.Connection, req dalutil.UpdateTypeRequest[svccore_entjobapplicant_typ.JobApplicant, svccore_entjobapplicant_typ.JobApplicantField], allowedFields []svccore_entjobapplicant_typ.JobApplicantField, elem svccore_entjobapplicant_typ.JobApplicant) (svccore_entjobapplicant_typ.JobApplicant, error) {
