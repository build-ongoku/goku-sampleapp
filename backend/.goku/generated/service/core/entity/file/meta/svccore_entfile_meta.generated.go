...
func (meta TypeFileMeta) SetMetaFieldValues(ctx context.Context, obj svccore_entfile_typ.File, now scalars.Timestamp) svccore_entfile_typ.File {
...
func (meta TypeFileMeta) InternalHookSavePre(ctx context.Context, elem svccore_entfile_typ.File, now scalars.Timestamp) (svccore_entfile_typ.File, error) {
	...
	if elem.ID.IsEmpty() {
		...
		llog.Warn(ctx, "Entity Files already has ID set", "value", elem.ID)
	}
	...
	if elem.CreatedAt.IsEmpty() {
		...
		llog.Warn(ctx, "Entity Files already has field CreatedAt set", "value", elem.CreatedAt)
	}
...
func (meta TypeFileMeta) standardizeTimestamps(ctx context.Context, elem svccore_entfile_typ.File) svccore_entfile_typ.File {
	// Standardize any timestamp fields.
...
func (meta TypeFileDALMeta) ScanDBNextRow(ctx context.Context, rows *sql.Rows) (svccore_entfile_typ.File, error) {
...
func (meta *TypeFileDALMeta) UpdateSubTableFields(ctx context.Context, conn db.Connection, req dalutil.UpdateTypeRequest[svccore_entfile_typ.File, svccore_entfile_typ.FileField], allowedFields []svccore_entfile_typ.FileField, elem, oldElem svccore_entfile_typ.File) (svccore_entfile_typ.File, error) {
	llog.Debug(ctx, "Updating sub-types", "parentType", "File", "ID", elem.ID)
