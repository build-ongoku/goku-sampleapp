package svccore_enttaskrun_httproute
...
func GetRoutes(ctx context.Context, c svccore_enttaskrun_client.Client) []gopi.Route {
	...
	routes = []gopi.Route{
		...
		},
		{
			...
			Method:       "GET",
			Version:      1,
			Path:         "/core/task_run/query_by_text",
