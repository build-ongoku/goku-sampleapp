package svcauth_entsecret_httproute
...
func GetRoutes(ctx context.Context, c svcauth_entsecret_client.Client) []gopi.Route {
	...
	routes = []gopi.Route{
		...
		},
		{
			...
			Method:       "GET",
			Version:      1,
			Path:         "/auth/secret/query_by_text",
