...
func (meta TypeSecretMeta) SetMetaFieldValues(ctx context.Context, obj svcauth_entsecret_typ.Secret, now time.Time) svcauth_entsecret_typ.Secret {
...
func (meta TypeSecretMeta) ConvertTimestampColumnsToUTC(obj svcauth_entsecret_typ.Secret) svcauth_entsecret_typ.Secret {
	return obj
}
...
func (meta TypeSecretDALMeta) ScanDBNextRow(rows *sql.Rows) (svcauth_entsecret_typ.Secret, error) {
...
func (meta *TypeSecretDALMeta) UpdateSubTableFields(ctx context.Context, conn db.Connection, req dalutil.UpdateTypeRequest[svcauth_entsecret_typ.Secret, svcauth_entsecret_typ.SecretField], allowedFields []svcauth_entsecret_typ.SecretField, elem svcauth_entsecret_typ.Secret) (svcauth_entsecret_typ.Secret, error) {
