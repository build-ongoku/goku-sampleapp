...
var _TypeUserMeta = TypeUserMeta{
	TypeCommonMeta: types.TypeCommonMeta[svcuser_entuser_typ.User, svcuser_entuser_typ.UserField]{
		...
		Fields: []svcuser_entuser_typ.UserField{
			...
			svcuser_entuser_typ.UserField_TeamsIDs,
		},
	},
}
...
func (meta TypeUserMeta) SetMetaFieldValues(ctx context.Context, obj svcuser_entuser_typ.User, now scalars.Timestamp) svcuser_entuser_typ.User {
...
func (meta TypeUserMeta) InternalHookSavePre(ctx context.Context, elem svcuser_entuser_typ.User, now scalars.Timestamp) (svcuser_entuser_typ.User, error) {
	...
	if elem.ID.IsEmpty() {
		...
		llog.Warn(ctx, "Entity Users already has ID set", "value", elem.ID)
	}
	...
	if elem.CreatedAt.IsEmpty() {
		...
		llog.Warn(ctx, "Entity Users already has field CreatedAt set", "value", elem.CreatedAt)
	}
...
func (meta TypeUserMeta) standardizeTimestamps(ctx context.Context, elem svcuser_entuser_typ.User) svcuser_entuser_typ.User {
	// Standardize any timestamp fields.
...
func (meta TypeUserDALMeta) GetDirectDBValues(obj svcuser_entuser_typ.User) []interface{} {
	...
	var vals = []interface{}{
		obj.ID,
		obj.Email, pq.Array(obj.PastTeamIDs),
		obj.CreatedAt,
		obj.UpdatedAt,
		obj.DeletedAt, pq.Array(obj.TeamsIDs),
	}
	return vals
}
...
func (meta TypeUserDALMeta) ScanDBNextRow(ctx context.Context, rows *sql.Rows) (svcuser_entuser_typ.User, error) {
...
func (meta TypeUserDALMeta) GetChangedFieldsAndValues(old, new svcuser_entuser_typ.User, allowedFields []svcuser_entuser_typ.UserField) ([]svcuser_entuser_typ.UserField, []interface{}) {
	...
	if types.IsFieldInFields(svcuser_entuser_typ.UserField_TeamsIDs, allowedFields) {
		vals = append(vals, pq.Array(new.TeamsIDs))
	}

	return colsWithValueChange, vals
}

func (meta *TypeUserDALMeta) UpdateSubTableFields(ctx context.Context, conn db.Connection, req dalutil.UpdateTypeRequest[svcuser_entuser_typ.User, svcuser_entuser_typ.UserField], allowedFields []svcuser_entuser_typ.UserField, elem, oldElem svcuser_entuser_typ.User) (svcuser_entuser_typ.User, error) {
	llog.Debug(ctx, "Updating sub-types", "parentType", "User", "ID", elem.ID)
	...
	// Update Addresses
	{
		llog.Debug(ctx, "Updating subtype ", "fieldName", "Addresses", "type", "AddressWithMeta")
