...
type User struct {
	...
	TeamsIDs    []scalars.ID               `json:"teamsIDs"`
}
...
func (t User) SetUpdatedAt(tim scalars.Timestamp) User {
	t.UpdatedAt = tim
	return t
}
...
func (f MethodName) ImplementsGraphQLType(name string) bool {
	return name == "User_User_MethodName"
}
...
const (
	...
	UserField_PastTeamIDs          UserField = 24
	UserField_CreatedAt            UserField = 25
	UserField_UpdatedAt            UserField = 26
	UserField_DeletedAt            UserField = 27
	UserField_TeamsIDs             UserField = 28
)
...
type UserFilter struct {
	...
	HavingTeamsIDs    *filterlib.IDCondition        `json:"havingTeamsIDs"`
...
// User: Main type for entity User
// UserFieldCondition:
// UserFilter:
