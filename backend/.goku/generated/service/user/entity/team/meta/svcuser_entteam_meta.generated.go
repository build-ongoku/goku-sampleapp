...
type EntityTeamDALMeta struct {
	dalutil.EntityCommonDALMeta[svcuser_entteam_typ.Team, svcuser_entteam_typ.TeamField]
}

// _EntityTeamDALMeta implements the singleton pattern.
var _EntityTeamDALMeta = EntityTeamDALMeta{
	dalutil.EntityCommonDALMeta[svcuser_entteam_typ.Team, svcuser_entteam_typ.TeamField]{
...
func GetEntityTeamDALMeta() *EntityTeamDALMeta {
	return &_EntityTeamDALMeta
}
...
func (meta TypeTeamMeta) SetMetaFieldValues(ctx context.Context, obj svcuser_entteam_typ.Team, now time.Time) svcuser_entteam_typ.Team {
...
func (meta TypeTeamMeta) ConvertTimestampColumnsToUTC(obj svcuser_entteam_typ.Team) svcuser_entteam_typ.Team {
	return obj
}
...
func (meta TypeTeamDALMeta) ScanDBNextRow(rows *sql.Rows) (svcuser_entteam_typ.Team, error) {
...
func (meta *TypeTeamDALMeta) UpdateSubTableFields(ctx context.Context, conn db.Connection, req dalutil.UpdateTypeRequest[svcuser_entteam_typ.Team, svcuser_entteam_typ.TeamField], allowedFields []svcuser_entteam_typ.TeamField, elem svcuser_entteam_typ.Team) (svcuser_entteam_typ.Team, error) {
