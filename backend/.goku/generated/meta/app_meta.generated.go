...
func (meta TypeAddressMeta) SetMetaFieldValues(ctx context.Context, obj app_typ.AddressWithMeta, now scalars.Timestamp) app_typ.AddressWithMeta {
...
func (meta TypeAddressMeta) InternalHookSavePre(ctx context.Context, elem app_typ.AddressWithMeta, now scalars.Timestamp) (app_typ.AddressWithMeta, error) {
	...
	if elem.ID.IsEmpty() {
		...
		llog.Warn(ctx, "Entity Addresses already has ID set", "value", elem.ID)
	}
	...
	if elem.CreatedAt.IsEmpty() {
		...
		llog.Warn(ctx, "Entity Addresses already has field CreatedAt set", "value", elem.CreatedAt)
	}
...
func (meta TypeAddressMeta) standardizeTimestamps(ctx context.Context, elem app_typ.AddressWithMeta) app_typ.AddressWithMeta {
	// Standardize any timestamp fields.
...
func (meta TypeAddressDALMeta) ScanDBNextRow(ctx context.Context, rows *sql.Rows) (app_typ.AddressWithMeta, error) {
...
func (meta *TypeAddressDALMeta) UpdateSubTableFields(ctx context.Context, conn db.Connection, req dalutil.UpdateTypeRequest[app_typ.AddressWithMeta, app_typ.AddressField], allowedFields []app_typ.AddressField, elem, oldElem app_typ.AddressWithMeta) (app_typ.AddressWithMeta, error) {
	llog.Debug(ctx, "Updating sub-types", "parentType", "Address", "ID", elem.ID)
...
func (meta TypeContactMeta) SetMetaFieldValues(ctx context.Context, obj app_typ.ContactWithMeta, now scalars.Timestamp) app_typ.ContactWithMeta {
...
func (meta TypeContactMeta) InternalHookSavePre(ctx context.Context, elem app_typ.ContactWithMeta, now scalars.Timestamp) (app_typ.ContactWithMeta, error) {
	// Set meta field values, if not already set
	...
	if elem.ID.IsEmpty() {
		...
		llog.Warn(ctx, "Entity Contacts already has ID set", "value", elem.ID)
	}
	...
	if elem.CreatedAt.IsEmpty() {
		...
		llog.Warn(ctx, "Entity Contacts already has field CreatedAt set", "value", elem.CreatedAt)
	}
...
func (meta TypeContactMeta) standardizeTimestamps(ctx context.Context, elem app_typ.ContactWithMeta) app_typ.ContactWithMeta {
	// Standardize any timestamp fields.
...
func (meta TypeContactDALMeta) ScanDBNextRow(ctx context.Context, rows *sql.Rows) (app_typ.ContactWithMeta, error) {
...
func (meta *TypeContactDALMeta) UpdateSubTableFields(ctx context.Context, conn db.Connection, req dalutil.UpdateTypeRequest[app_typ.ContactWithMeta, app_typ.ContactField], allowedFields []app_typ.ContactField, elem, oldElem app_typ.ContactWithMeta) (app_typ.ContactWithMeta, error) {
	llog.Debug(ctx, "Updating sub-types", "parentType", "Contact", "ID", elem.ID)

	// Update Nested (1:1 & 1:Many)
	// Update Name
	{
		llog.Debug(ctx, "Updating subtype ", "fieldName", "Name", "type", "PersonNameWithMeta")
	...
	// Update Address
	{
		llog.Debug(ctx, "Updating subtype ", "fieldName", "Address", "type", "AddressWithMeta")
...
func (meta TypePersonNameMeta) SetMetaFieldValues(ctx context.Context, obj app_typ.PersonNameWithMeta, now scalars.Timestamp) app_typ.PersonNameWithMeta {
...
func (meta TypePersonNameMeta) InternalHookSavePre(ctx context.Context, elem app_typ.PersonNameWithMeta, now scalars.Timestamp) (app_typ.PersonNameWithMeta, error) {
	// Set meta field values, if not already set
	...
	if elem.ID.IsEmpty() {
		...
		llog.Warn(ctx, "Entity PersonNames already has ID set", "value", elem.ID)
	}
	...
	if elem.CreatedAt.IsEmpty() {
		...
		llog.Warn(ctx, "Entity PersonNames already has field CreatedAt set", "value", elem.CreatedAt)
	}
...
func (meta TypePersonNameMeta) standardizeTimestamps(ctx context.Context, elem app_typ.PersonNameWithMeta) app_typ.PersonNameWithMeta {
	// Standardize any timestamp fields.
...
func (meta TypePersonNameDALMeta) ScanDBNextRow(ctx context.Context, rows *sql.Rows) (app_typ.PersonNameWithMeta, error) {
...
func (meta *TypePersonNameDALMeta) UpdateSubTableFields(ctx context.Context, conn db.Connection, req dalutil.UpdateTypeRequest[app_typ.PersonNameWithMeta, app_typ.PersonNameField], allowedFields []app_typ.PersonNameField, elem, oldElem app_typ.PersonNameWithMeta) (app_typ.PersonNameWithMeta, error) {
	llog.Debug(ctx, "Updating sub-types", "parentType", "PersonName", "ID", elem.ID)
...
func (meta TypePhoneNumberMeta) SetMetaFieldValues(ctx context.Context, obj app_typ.PhoneNumberWithMeta, now scalars.Timestamp) app_typ.PhoneNumberWithMeta {
...
func (meta TypePhoneNumberMeta) InternalHookSavePre(ctx context.Context, elem app_typ.PhoneNumberWithMeta, now scalars.Timestamp) (app_typ.PhoneNumberWithMeta, error) {
	// Set meta field values, if not already set
	...
	if elem.ID.IsEmpty() {
		...
		llog.Warn(ctx, "Entity PhoneNumbers already has ID set", "value", elem.ID)
	}
	...
	if elem.CreatedAt.IsEmpty() {
		...
		llog.Warn(ctx, "Entity PhoneNumbers already has field CreatedAt set", "value", elem.CreatedAt)
	}
...
func (meta TypePhoneNumberMeta) standardizeTimestamps(ctx context.Context, elem app_typ.PhoneNumberWithMeta) app_typ.PhoneNumberWithMeta {
	// Standardize any timestamp fields.
...
func (meta TypePhoneNumberDALMeta) ScanDBNextRow(ctx context.Context, rows *sql.Rows) (app_typ.PhoneNumberWithMeta, error) {
...
func (meta *TypePhoneNumberDALMeta) UpdateSubTableFields(ctx context.Context, conn db.Connection, req dalutil.UpdateTypeRequest[app_typ.PhoneNumberWithMeta, app_typ.PhoneNumberField], allowedFields []app_typ.PhoneNumberField, elem, oldElem app_typ.PhoneNumberWithMeta) (app_typ.PhoneNumberWithMeta, error) {
	llog.Debug(ctx, "Updating sub-types", "parentType", "PhoneNumber", "ID", elem.ID)
