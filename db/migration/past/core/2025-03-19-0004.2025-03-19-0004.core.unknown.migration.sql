CREATE TABLE public.tb_file (
    ...
    size_bytes integer,
    storage_client text,
    storage_client_identifier text DEFAULT ''::text,
...
CREATE TABLE public.tb_secret_decryptable (
    id uuid NOT NULL,
    encrypted_value text DEFAULT ''::text,
...
ALTER TABLE public.tb_secret_key ADD CONSTRAINT chk_secret_key__key__empty_str CHECK (key <> ''::TEXT);
